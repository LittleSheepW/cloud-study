...
public class StudentController {
    ...
    public StudentVo updateStudent(@RequestBody StudentPvo studentPvo) {
    ...
    public Integer deleteStudent(@PathVariable(value = "id") Integer studentId) {
